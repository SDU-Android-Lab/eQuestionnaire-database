...
public class Main extends JFrame {
	...
	public Main() {
		...
		mnexcel.setFont(new Font("华文行楷", Font.PLAIN, 18));
		...
		mnexcel_1.setFont(new Font("华文行楷", Font.PLAIN, 18));
		...
		menu.setFont(new Font("华文行楷", Font.PLAIN, 18));
		menuBar.add(menu);
		
		JMenuItem menuItem_4 = new JMenuItem("\u5E10\u53F7\u8BBE\u7F6E");
		menuItem_4.setSelected(true);
		menuItem_4.setFont(new Font("华文行楷", Font.PLAIN, 18));
		menu.add(menuItem_4);
		
		JMenuItem menuItem_5 = new JMenuItem("\u7BA1\u7406\u5458\u4FE1\u606F");
		menuItem_5.setFont(new Font("华文行楷", Font.PLAIN, 18));
		menu.add(menuItem_5);
		
		JMenuItem menuItem_6 = new JMenuItem("\u5458\u5DE5\u7BA1\u7406");
		menuItem_6.setFont(new Font("华文行楷", Font.PLAIN, 18));
		menu.add(menuItem_6);
		
		JMenuItem menuItem_7 = new JMenuItem("\u5BA2\u6237\u4FE1\u606F");
		menuItem_7.setFont(new Font("华文行楷", Font.PLAIN, 18));
		menu.add(menuItem_7);
		...
		AdminitorFrame adminitorFrame = UIFactory.getAdminitorFrame();
